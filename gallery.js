window.onload = () => {
  ...
  btnShareKa.addEventListener("click", () => {
    Kakao.Share.sendDefault({
      objectType: "feed",
      content: {
        title: "김성현 ♥ 고슬기의 모바일 청첩장",
        description: "2025년 2월 22일 토요일♡",
        imageUrl: "https://i.imgur.com/zicUf7Y.png",
        imageWidth: 1200,
        imageHeight: 630,
        link: {
          mobileWebUrl: "https:/mo49.luvle.co.kr",
          webUrl: "https://mo49.luvle.co.kr",
        },
      },
      buttons: [
        {
